# PHP-FPM 5.5 Docker Image

[![Build Status](https://travis-ci.org/devilbox/docker-php-fpm-5.5.svg?branch=master)](https://travis-ci.org/devilbox/docker-php-fpm-5.5)
...
[![](https://images.microbadger.com/badges/license/devilbox/php-fpm-5.5.svg)](https://microbadger.com/images/devilbox/php-fpm-5.5 "php-fpm-5.5")
[![Github](https://img.shields.io/badge/github-docker--php--fpm--5.5-red.svg)](https://github.com/devilbox/docker-php-fpm-5.5)

**[devilbox/docker-php-fpm-5.5](https://github.com/devilbox/docker-php-fpm-5.5)**

This repository will provide you fully functional PHP-FPM 5.5 Docker images in different flavours and packed with different types of integrated PHP modules. It also solves the problem of [syncronizing file permissions](#unsynchronized-permissions) of mounted volumes between the host and the container.

Choose between [Alpine](https://www.alpinelinux.org) or [Debian](https://www.debian.org) and select an image type for extending, use in production or use for local development. Images are always guaranteed to be fresh and up-to-date as they are automatically built every night by [travis-ci](https://travis-ci.org/devilbox/docker-php-fpm-5.5) and pushed to [Docker hub](https://hub.docker.com/r/devilbox/php-fpm-5.5/).
...
```shell
$ docker run -e NEW_UID=1000 -e NEW_GID=1000 -it devilbox/php-fpm-5.5:base-alpine
...
[INFO] Starting PHP 5.5.0-dev (fpm-fcgi) (built: Oct 30 2017 12:05:19)
```
...
<h2><img id="php-fpm-5.5-flavours" width="20" src="https://github.com/devilbox/artwork/raw/master/submissions_logo/cytopia/01/png/logo_64_trans.png"> PHP-FPM 5.5 Flavours</h2>
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td><code>devilbox/php-fpm-5.5:base-alpine</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:base-alpine.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:base-alpine.svg" /></a>
   </td>
  </tr>
  <tr>
   <td><code>devilbox/php-fpm-5.5:base-debian</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:base-debian.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:base-debian.svg" /></a>
   </td>
  </tr>
  <tr>
   <td colspan="3"></td>
  ...
  <tr>
   ...
   <td><code>devilbox/php-fpm-5.5:mods-alpine</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:mods-alpine.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:mods-alpine.svg" /></a>
   </td>
  </tr>
  <tr>
   <td><code>devilbox/php-fpm-5.5:mods-debian</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:mods-debian.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:mods-debian.svg" /></a>
   </td>
  </tr>
  <tr>
   <td colspan="3"></td>
  ...
  <tr>
   ...
   <td><code>devilbox/php-fpm-5.5:prod-alpine</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:prod-alpine.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:prod-alpine.svg" /></a>
   </td>
  </tr>
  <tr>
   <td><code>devilbox/php-fpm-5.5:prod-debian</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:prod-debian.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:prod-debian.svg" /></a>
   </td>
  </tr>
  <tr>
   <td colspan="3"></td>
  ...
  <tr>
   ...
   <td><code>devilbox/php-fpm-5.5:work-alpine</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:work-alpine.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:work-alpine.svg" /></a>
   </td>
  </tr>
  <tr>
   <td><code>devilbox/php-fpm-5.5:work-debian</code></td>
   <td>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:work-debian.svg" /></a>
    <a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:work-debian.svg" /></a>
   </td>
  </tr>
 </tbody>
</table>
...
This repository uses Docker tags to refer to different flavours and types of the PHP-FPM 5.5 Docker image. Therefore `:latest` and `:<git-branch-name>` as well as `:<git-tag-name>` must be presented differently. Refer to the following table to see how tagged Docker images are produced at Docker hub:
...
<h2><img id="php-fpm-5.5-features" width="20" src="https://github.com/devilbox/artwork/raw/master/submissions_logo/cytopia/01/png/logo_64_trans.png"> PHP-FPM 5.5 Features</h2>

#### Image: base
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:base-alpine.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:base-alpine.svg" /></a><br/>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:base-debian.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:base-debian.svg" /></a>
```shell
docker pull devilbox/php-fpm-5.5:base-alpine
docker pull devilbox/php-fpm-5.5:base-debian
```
...
#### Image: mods
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:mods-alpine.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:mods-alpine.svg" /></a><br/>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:mods-debian.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:mods-debian.svg" /></a>
```shell
docker pull devilbox/php-fpm-5.5:mods-alpine
docker pull devilbox/php-fpm-5.5:mods-debian
```
...
#### Image: prod
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:prod-alpine.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:prod-alpine.svg" /></a><br/>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:prod-debian.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:prod-debian.svg" /></a>
```shell
docker pull devilbox/php-fpm-5.5:prod-alpine
docker pull devilbox/php-fpm-5.5:prod-debian
```
...
#### Image: work
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:work-alpine.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:work-alpine.svg" /></a><br/>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/version/devilbox/php-fpm-5.5:work-debian.svg" /></a>
<a href="https://microbadger.com/images/devilbox/php-fpm-5.5"><img src="https://images.microbadger.com/badges/image/devilbox/php-fpm-5.5:work-debian.svg" /></a>
```shell
docker pull devilbox/php-fpm-5.5:work-alpine
docker pull devilbox/php-fpm-5.5:work-debian
```
...
<h2><img id="php-fpm-5.5-options" width="20" src="https://github.com/devilbox/artwork/raw/master/submissions_logo/cytopia/01/png/logo_64_trans.png"> PHP-FPM 5.5 Options</h2>
...
$ docker run -d \
    ...
    -t devilbox/php-fpm-5.5:prod-debian
```
...
$ docker run -d \
    ...
    --name php \
    -t devilbox/php-fpm-5.5:work-debian
...
Docker images are built and tested every night by **[travis-ci](https://travis-ci.org/devilbox/docker-php-fpm-5.5)** and pushed to **[Docker hub](https://hub.docker.com/r/devilbox/php-fpm-5.5/)** on success. This is all done automatically to ensure that sources as well as base images are always fresh and in case of security updates always have the latest patches.
